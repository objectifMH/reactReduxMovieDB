                            ...
                            <div className="modal-dialog modal-dialog-centered">
                                <div className="modal-content">
                                    ...
                                    <div className="modal-body" >
                                        ...
                                        <p className="card-text">{this.state.filmCollapse.release_date}
                                            <Link className="nav-link close" to={
                                                ...
                                                <span  className="btn btn-success btn-sm mt-2 ml-3" data-toggle="modal" data-target="#myModal">Voir fiche</span>
                                            </Link>
                                        </p>
                                    </div>
